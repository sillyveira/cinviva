...
const getMercadoData = (mercadoId) => {
  const mercadosDatabase = {
    saojose: {
      ...
      imagemUrl: "https://mercadosempe.com/wp-content/uploads/2022/06/001-mercadosempe-saojose-1024x683.jpg",
      horarios: [
    ...
    casaamarela: {
      ...
      localizacao: "Praça Dom Vital, S/N - São JoséRua Padre Lemos, 94 - Casa Amarela",
      imagemUrl: "https://mercadosempe.com/wp-content/uploads/2022/06/001-mercadosempe-casa-amarela-1024x683.jpg",
      horarios: [
        { day: "Segunda-feira", time: "06:00 - 18:00", isSpecial: false },
        { day: "Terça-feira", time: "06:00 - 18:00", isSpecial: false },
        { day: "Quarta-feira", time: "06:00 - 18:00", isSpecial: false },
    ...
    encruzilhada: {
      ...
      imagemUrl: "https://mercadosempe.com/wp-content/uploads/2022/06/001-mercadosempe-encruzilhada-1024x683.jpg",
      horarios: [
        { day: "Segunda-feira", time: "06:00 - 18:00", isSpecial: false },
        { day: "Terça-feira", time: "06:00 - 18:00", isSpecial: false },
        { day: "Quarta-feira", time: "06:00 - 18:00", isSpecial: false },
    ...
    beberibe: {
      ...
      imagemUrl: "https://conexaope.com.br/wp-content/uploads/2025/02/IMG_1149-780x470.jpeg",
      horarios: [
        { day: "Segunda-feira", time: "06:00 - 18:00", isSpecial: false },
        { day: "Terça-feira", time: "06:00 - 18:00", isSpecial: false },
        { day: "Quarta-feira", time: "06:00 - 18:00", isSpecial: false },
    ...
    novadescoberta: {
      ...
      imagemUrl: "http://observatoriogastronomico.senac.br/wp-content/uploads/2019/10/1-600x450.jpg",
      horarios: [
        { day: "Segunda-feira", time: "06:00 - 18:00", isSpecial: false },
        { day: "Terça-feira", time: "06:00 - 18:00", isSpecial: false },
        { day: "Quarta-feira", time: "06:00 - 18:00", isSpecial: false },
    ...
    boavista: {
      ...
      imagemUrl: "https://cdn.folhape.com.br/img/pc/1100/1/dn_arquivo/2023/04/mercado-da-boa-vista-foto-ed-machado-01.jpg",
      horarios: [
        { day: "Segunda-feira", time: "06:00 - 18:00", isSpecial: false },
        { day: "Terça-feira", time: "06:00 - 18:00", isSpecial: false },
        { day: "Quarta-feira", time: "06:00 - 18:00", isSpecial: false },
    ...
    madalena: {
      ...
      imagemUrl: "https://mercadosempe.com/wp-content/uploads/2022/06/002-mercadosempe-madalena.jpg",
      horarios: [
        { day: "Segunda-feira", time: "06:00 - 18:00", isSpecial: false },
        { day: "Terça-feira", time: "06:00 - 18:00", isSpecial: false },
        { day: "Quarta-feira", time: "06:00 - 18:00", isSpecial: false },
    ...
    cordeiro: {
      ...
      imagemUrl: "https://www.diariodepernambuco.com.br/static/app/noticia_127983242361/2022/03/21/889454/20220321164310439876i.jpg",
      horarios: [
        { day: "Segunda-feira", time: "06:00 - 18:00", isSpecial: false },
        { day: "Terça-feira", time: "06:00 - 18:00", isSpecial: false },
        { day: "Quarta-feira", time: "06:00 - 18:00", isSpecial: false },
...
export default function Mercado() {
  ...
  return (
    <div className="bg-white min-h-screen p-6">
      ...
      {/* Imagem Arredondada */}
      <div className="w-full max-h-[350px] rounded-3xl mb-6 shadow-md overflow-hidden">
        <img 
